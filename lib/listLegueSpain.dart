class ListLegueSpain {
  List<Teamsku>? myteams;

  ListLegueSpain({this.myteams});

  ListLegueSpain.fromJson(Map<String, dynamic> json) {
    if (json['teams'] != null) {
      myteams = <Teamsku>[];
      json['teams'].forEach((i) {
        myteams!.add(new Teamsku.fromJson(i));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.myteams != null) {
      data['teams'] = this.myteams!.map((i) => i.toJson()).toList();
    }
    return data;
  }
}
...
class Teamsku {
  ...
  Teamsku.fromJson(Map<String, dynamic> json) {
    idTeam = json['idTeam'];
